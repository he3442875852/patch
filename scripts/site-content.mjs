export const site = {
  ...
  whatsappText: 'Hello HeyPalPatch, I would like to request a quotation for custom patches. I can provide my artwork, size, quantity and shipping country.',
  location: 'China',
  image: '/assets/patch-embroidered.webp',
  description: 'HeyPalPatch helps brands, teams, clubs and merchandise buyers coordinate custom patch orders. We review project requirements, compare patch materials, prepare quotations, coordinate digital proofs, arrange production after approval and provide shipment photos and tracking information before delivery.'
};
...
export const products = [
  {
    ...
    image: '/assets/patch-embroidered.webp',
    title: 'Custom Embroidered Patches | HeyPalPatch',
    ...
    direct: 'An embroidered patch is a fabric patch made with stitched thread over a twill or fabric base. It is commonly used for uniforms, hats, jackets and merchandise. HeyPalPatch accepts embroidered patch orders from 50 pieces and provides a digital proof for approval before bulk production is arranged.',
  ...
  },
  {
    ...
    title: 'Custom Woven Patches for Fine Detail | HeyPalPatch',
    ...
    direct: 'A woven patch uses fine threads woven into a flatter surface than embroidery. It is a practical choice when a logo has small text, thin lines or detailed shapes. HeyPalPatch coordinates woven patch orders from 100 pieces, with a digital proof prepared before bulk production is arranged.',
  ...
  },
  {
    ...
    title: 'Custom PVC Patches for Gear and Bags | HeyPalPatch',
    ...
    direct: 'A PVC patch is a flexible molded rubber patch with layered color areas and a durable surface. It works well for outdoor gear, bags, morale patches and bold logos. HeyPalPatch coordinates PVC patch orders from 100 pieces and arranges production only after the customer approves the digital proof.',
  ...
  },
  {
    ...
    title: 'Custom Chenille Patches for Varsity Style | HeyPalPatch',
    ...
    direct: 'A chenille patch uses plush loop yarn over a felt or fabric base, creating a soft varsity-style texture. It is best for large letters, numbers and bold shapes. HeyPalPatch coordinates chenille patch orders from 100 pieces and confirms the digital proof before bulk production is arranged.',
  ...
  },
  {
    ...
    title: 'Custom Leather Patches for Hats and Apparel | HeyPalPatch',
    ...
    direct: 'A leather patch is a branded label made from genuine leather or PU leather, often with embossed, debossed or laser engraved artwork. It is commonly used on hats, denim, workwear and bags. HeyPalPatch coordinates leather patch orders from 100 pieces and provides proof approval before production is arranged.',
  ...
  },
  {
    ...
    title: 'Custom Printed Patches for Full-Color Artwork | HeyPalPatch',
    ...
    direct: 'A printed patch uses a flat printed textile surface, making it suitable for gradients, illustrations, photo-style artwork and complex color transitions. HeyPalPatch coordinates printed patch orders from 100 pieces and prepares a digital proof before bulk production is arranged after approval.',
...
export const faqItems = [
  ...
  ['Where is HeyPalPatch based?', 'HeyPalPatch is based in China and supports international custom patch inquiries and order coordination.']
];
...
export const orderSteps = [
  ...
  ['Receive a Quotation', 'HeyPalPatch reviews design, size, colors, quantity, material, backing, border and shipping requirements before preparing a quotation.'],
